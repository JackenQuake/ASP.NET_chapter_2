...
namespace Timesheets.Models.Implementations
{
	...
	public class PersonsModel : GenericMapper<PersonDto, PersonStorage>, IPersonsModel
	{
		...
		/// </summary>
		protected PersonsModel(IPersonsRepository repository, IMapper mapper, IPersonValidationService validationService, ILogger<PersonsModel> logger, string title) :
			base(repository, mapper, validationService, logger, title)
		{ }
